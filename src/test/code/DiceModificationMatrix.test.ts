...
describe("DiceModificationMatrix", () => {
  ...
  it("convert up as expected", () => {
    ...
    expect(
      matrix.tryConvertResult(T.AttackDieResult.Hit, T.AttackDieResult.Critical)
    ).toEqual(false);
    expect(
      matrix.tryConvertResult(T.AttackDieResult.Surge, T.AttackDieResult.Hit)
    ).toEqual(true);
  ...
  it("convert down as expected", () => {
    ...
    expect(
      matrix.tryConvertResult(T.AttackDieResult.Hit, T.AttackDieResult.Miss)
    ).toEqual(true);
    expect(matrix.getResultCount(T.AttackDieResult.Hit)).toEqual(0);
  ...
  it("convert back", () => {
    ...
    expect(
      matrix.tryConvertResult(T.AttackDieResult.Miss, T.AttackDieResult.Hit)
    ).toEqual(true);
  ...
  it("returns expected conversions", () => {
    ...
    expect(matrix.getConversions()).toStrictEqual([
      {
        roll: { color: T.DieColor.Red, result: T.AttackDieResult.Surge },
        conversion: T.AttackDieResult.Miss,
      },
      {
        roll: { color: T.DieColor.Black, result: T.AttackDieResult.Surge },
        conversion: T.AttackDieResult.Miss,
      },
      {
        roll: { color: T.DieColor.White, result: T.AttackDieResult.Hit },
        conversion: T.AttackDieResult.Hit,
      },
      {
        roll: { color: T.DieColor.White, result: T.AttackDieResult.Hit },
        conversion: T.AttackDieResult.Hit,
      ...
      {
        roll: { color: T.DieColor.White, result: T.AttackDieResult.Surge },
        conversion: T.AttackDieResult.Critical,
      },
    ]);
  });
  ...
  it("converts values leaving expected amount", () => {
    ...
    expect(
      matrix.tryConvertResultAllExcept(
        T.AttackDieResult.Hit,
        T.AttackDieResult.Miss,
        4
      )
