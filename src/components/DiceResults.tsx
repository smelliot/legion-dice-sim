...
class DiceResults extends React.Component<DiceResultsProps, DiceResultsState> {
  private rootElementRef: React.RefObject<HTMLDivElement | null>;
              ...
              load: function () {
                ...
                this.renderer
                  .text(
                    "Median:",
                    savesLeft,
                    verticalStart + verticalOffset * 2,
                    true
                  )
                  .css(statCss)
                  .add();
                this.renderer
                  .text(
                    "Standard Deviation:",
                    savesLeft,
                    verticalStart + verticalOffset * 3,
                    true
                  )
                  .css(statCss)
                  .add();
  ...
  render(): React.JSX.Element {
    return (
      <div ref={this.rootElementRef}>
        <div
          className={`single-result justify-content-center my-3 ${this.props.visibility === T.ResultOutput.Single ? "collapse.show" : "collapse"}`}
        >
        ...
        >
          <span className="die-result">
            Wounds: {this.getFirstWoundCount()}
          </span>
        </div>
        <div
          id="chartContainer"
          className={`my-3 mx-auto ${this.props.visibility === T.ResultOutput.Graph ? "collapse.show" : "collapse"}`}
        >
          <HighchartsReact
        ...
        <div
          className={`row ${this.props.visibility === T.ResultOutput.Graph ? "collapse.show" : "collapse"}`}
        >
