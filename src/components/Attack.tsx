...
function Attack(props: AttackProps): React.JSX.Element {
  const handleAttackSurgeConversionChange = (
  ...
  return (
    <div>
      ...
      <div className="d-flex justify-content-center my-2">
        <DieCounter
          count={props.input.redDice}
          styleName="btn-danger"
          onClick={props.eventHandlers.incrementRedDice}
        ></DieCounter>
        <DieCounter
          count={props.input.blackDice}
          styleName="btn-dark"
          onClick={props.eventHandlers.incrementBlackDice}
        ></DieCounter>
        <DieCounter
          count={props.input.whiteDice}
          styleName="btn-light"
          onClick={props.eventHandlers.incrementWhiteDice}
        ></DieCounter>
        <ClearButton
          onClick={props.eventHandlers.resetDiceCount}
